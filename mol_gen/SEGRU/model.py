...
class CharRNN(nn.Module):
    ...
    def __init__(self, vocabulary, config):
        ...
        self.gru_layer = nn.GRU(self.input_size, self.hidden_size,
    ...
    def forward(self, x, lengths, hiddens=None):
        ...
        x = rnn_utils.pack_padded_sequence(x, lengths.cpu().long(), batch_first=True)
        x, hiddens = self.gru_layer(x, hiddens)
